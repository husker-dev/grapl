...
class MacDisplayPeer(
    ...
    companion object {
        ...
        @JvmStatic private external fun nGetSize(screen: Long): IntArray
        @JvmStatic private external fun nGetPosition(screen: Long): IntArray
        @JvmStatic private external fun nGetPhysicalSize(screen: Long): IntArray
    ...
    private fun scaledSize(width: Int, height: Int): Size {
        val dpi = dpi
